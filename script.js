const content = {
  en: {
    ...
    screenshot: "assets/screenshot-en.jpg",
  ...
  pl: {
    ...
    icon: "assets/icon-pl.png",
    screenshot: "assets/screenshot-pl.jpg",
...
function setLang(lang) {
  ...
  document.getElementById("brandIcon").alt = `${t.brandName} app icon`;
  document.getElementById("appIcon").src = t.icon;
  document.getElementById("appIcon").alt = `${t.brandName} app icon`;
  document.getElementById("preview").src = t.screenshot;
  document.getElementById("preview").alt = `${t.brandName} preview`;
